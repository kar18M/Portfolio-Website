...
const Contact: React.FC<ContactProps> = (props) => {
    ...
    async function submitForm() {
        ...
        try {
            setIsLoading(true);
            // Contact form - messages will be sent to email
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/kar18M'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/m-karthick-072989379/'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I am currently a student with hands-on project experience in
                    AI and software development. If you have any opportunities or
                    collaboration ideas, feel free to reach out - I would love to
